...
tema_zemljevid <- function() {
  ...
  theme(plot.background=element_rect(fill="gray62"),  #ta pobarva tudi za naslovom ozadje
        panel.background=element_rect(fill="gray62", color="gray62")) +
    ...
    theme(legend.background = element_rect(fill="gray62")) + #barva ozadja legende
